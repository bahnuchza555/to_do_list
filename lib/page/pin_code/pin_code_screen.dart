...
class _PinCodeScreen extends State<PinCodeScreen> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        NumpadButton(
                          text: '1',
                          onPressed: () async => await setValue('1'),
                        ),
                        NumpadButton(
                          text: '2',
                          onPressed: () async => await setValue('2'),
                        ),
                        NumpadButton(
                          text: '3',
                          onPressed: () async => await setValue('3'),
                        ),
                      ],
                    ),
                    SizedBox(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        NumpadButton(
                          text: '4',
                          onPressed: () async => await setValue('4'),
                        ),
                        NumpadButton(
                          text: '5',
                          onPressed: () async => await setValue('5'),
                        ),
                        NumpadButton(
                          text: '6',
                          onPressed: () async => await setValue('6'),
                        ),
                      ],
                    ),
                    SizedBox(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        NumpadButton(
                          text: '7',
                          onPressed: () async => await setValue('7'),
                        ),
                        NumpadButton(
                          text: '8',
                          onPressed: () async => await setValue('8'),
                        ),
                        NumpadButton(
                          text: '9',
                          onPressed: () async => await setValue('9'),
                        ),
                      ],
                    ),
                    SizedBox(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        NumpadButton(
                          text: '0',
                          onPressed: () async => await setValue('0'),
                        ),
                        NumpadButton(
                          onPressed: () async => await deleteValue(enteredPin),
                        ),
                      ],
                    ),
                  ],
  ...
  deleteValue(String val) async {
    if (val.length > 0) {
      setState(() {
        enteredPin = val.split('').sublist(0, val.length - 1).join('');
      });
    }
  }
}
